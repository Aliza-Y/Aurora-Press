      ...
      >
        <div className="bg-[#1A1F2B] rounded-2xl p-8 shadow-xl border border-[#2DD4BF]/10">
          <div className="text-center">
            ...
            >
              Welcome to AuroraPress! Your account has been created and you're ready to start your journey.
            </motion.p>
            ...
            >
              ...
              <Link
                href="/auth"
                className="block w-full py-3 px-4 border border-[#2DD4BF]/20 text-[#2DD4BF] font-semibold rounded-lg hover:bg-[#2DD4BF]/10 transition-colors text-center"
              >
                Back to Login
              </Link>
            </motion.div>
